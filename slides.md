...
- Stored on your drive (only requested by the server if necessary)
  - C:\\Program Files (x86)\\Steam\\userdata\\<span class="text-green-500">100691295</span>\\<span class="text-yellow-500">990080</span>\\<span class="text-blue-500">94149734061</span>
- Blob decodes to an xml file:

```xml {*|1|2|3}
<ai>990080</ai>                                         <!-- App ID: Hogwarts Legacy -->
<ui>5f6d000601001001</ui>                               <!-- Steam User ID -->
<gt>CQBFR0aGA0eM2o ... eXYYW1BGYPLhA_THfJVDAgJ2c=</gt>  <!-- Base64 encoded token data -->
```
...
→ Mostly guessed, I didn't reverse engineer that in depth
